package com.mortuza.digitalsquaremed.DownloadService;
...
import com.mortuza.digitalsquaremed.service.BackgroundNotificationService;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(PROGRESS_UPDATE)) {
                ...
                if (downloadComplete) {
                    ...
                    Picasso.get().load(file).into(mImageShow);
